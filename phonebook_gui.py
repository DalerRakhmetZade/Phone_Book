...
def load_gui(self):
    ...
    self.lbl_fname.configure(bg="#dddddd")
    self.lbl_lname = tk.Label(self.master,text='Last Name:')
    self.lbl_lname.grid(row=2,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_lname.configure(bg="#dddddd")
    self.lbl_phone = tk.Label(self.master,text='Phone Number:')
    self.lbl_phone.grid(row=4,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_phone.configure(bg="#dddddd")
    self.lbl_email = tk.Label(self.master,text='Email Address:')
    self.lbl_email.grid(row=6,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_email.configure(bg="#dddddd")
    self.lbl_info = tk.Label(self.master,text='Current Contacts:')
    self.lbl_info.grid(row=0,column=2,padx=(0,0),pady=(10,0),sticky=N+W)
    self.lbl_info.configure(bg="#dddddd")
    ...
    self.logo = PhotoImage(file = 'logo.gif').subsample(12,12)
    ttk.Label(self.master, image = self.logo, background = '#dddddd').grid(row = 9, column = 5)
